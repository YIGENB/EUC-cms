	...
	public class MemcachedClient 
	{
		...
		public Hashtable Stats(ArrayList servers, string command) 
		{
			...
			for(int i = 0; i < servers.Count; i++) 
			{
				...
				// build command
				command = DY.Common.Utils.StrIsNullOrEmpty(command) ?  "stats\r\n": command + "\r\n";
        ...
        private static ResourceManager _resourceManager = new ResourceManager("DY.Cache.MemCached.StringMessages", typeof(MemcachedClient).Assembly);
