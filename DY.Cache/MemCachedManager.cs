...
namespace DY.Cache
{
    ...
    public sealed class MemCachedManager
    {
        ...
        public static string[] GetConnectedSocketHost()
        {
            ...
            {
                if (!DY.Common.Utils.StrIsNullOrEmpty(hostName))
                {
                    try
                    {
                        ...
                        if (sock != null)
                        {
                            connectedHost = DY.Common.Utils.MergeString(hostName, connectedHost);
                        }
                    }
                    finally
                    {
            ...
            return DY.Common.Utils.SplitString(connectedHost, ",");
        }
