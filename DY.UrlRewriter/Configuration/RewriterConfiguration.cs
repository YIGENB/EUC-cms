...
using DY.UrlRewriter.Parsers;
using DY.UrlRewriter.Transforms;
using DY.UrlRewriter.Utilities;
using DY.UrlRewriter.Logging;

namespace DY.UrlRewriter.Configuration
{
	/// <summary>
	...
	public class RewriterConfiguration
	{
		...
		{
			RewriterConfiguration config = (RewriterConfiguration)RewriterConfigurationReader.Read(node);
			HttpRuntime.Cache.Add(_cacheName, config, null, DateTime.Now.AddHours(1.0), TimeSpan.Zero, CacheItemPriority.Default, null);
