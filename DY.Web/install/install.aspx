<%@ Page Language="c#" Inherits="DY.Install.install" %>
...
<body>
<div class="wrap cl">
	<h2><img alt="Ctmon|BBS|论坛" src="images/logo.png" /><cite><b>Ctmon营销系统</b>安装程序</cite></h2>
	<div class="nav">
        <ul>
		    ...
		    <li <%if(stepNum==3){ %> class="cur"<%}else if(stepNum>3){ %> class="finish"<%} %>><span>网站配置</span></li>
	...
	<div class="main cl">
        ...
        <div class="inner">
            <h2>Ctmon 代码使用协议</h2>
            <strong>版权所有 (c) 20013-2015，深圳市创同盟科技有限公司,保留所有权利</strong>。 
            <br>
            <br>
            <p>感谢您选择 Ctmon 社区产品，希望我们的努力能为您提供一个高效快速和强大的社区论坛解决方案。 </p>
            <p>深圳市创同盟科技有限公司为 Ctmon 产品的开发商，依法独立拥有 Ctmon 产品著作权。深圳市创同盟科技有限公司网址为 <a href="http://www.ctmon.com" target="_blank">http://www.ctmon.com</a>。 </p>
            <p>Ctmon 著作权已在中华人民共和国国家版权局注册，著作权受到法律和国际公约保护。使用者：无论个人或组织、盈利与否、用途如何（包括以学习和研究为目的），均需仔细阅读本协议，在理解、同意、并遵守本协议的全部条款后，方可开始使用 Ctmon 软件。 </p>
            <p>本授权协议适用且仅适用于 Ctmon 3.3版本，深圳市创同盟科技有限公司拥有对本授权协议的最终解释权。 <br></p>
            <p></p>
            <h2>协议许可的权利</h2>
                1) 您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付费用。 <br>
            <br>
            2) 您可以在协议规定的约束和限制范围内修改 Ctmon 源代码(如果被提供的话)或界面风格以适应您的网站要求。 <br>
            <br>
            ...
            <br>
            3) 无论如何，即无论用途如何、是否经过修改或美化、修改程度如何，只要使用 Ctmon 的整体或任何部分，未经书面许可，论坛页面页脚处的 Ctmon 名称和深圳市创同盟科技有限公司下属网站（http://www.ctmon.com） 的链接都必须保留，而不能清除或修改。<br> 
            <br>
            4) 禁止在 Ctmon 的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。 与其它条款无抵触的前提下，允许以自用为目的的进行进行二次开发或整合，但同样受前文第3项约束和限制，即保留Ctmon名称与链接。<br>
            <br>
            ...
            <br>
            3) 深圳市创同盟科技有限公司不对使用本软件构建的论坛中的文章或信息承担责任。<br>
            <br>
            有关 Ctmon 最终用户授权协议、商业授权与技术服务的详细内容，均由 Ctmon 官方网站独家提供。深圳市创同盟科技有限公司拥有在不事先通知的情况下，修改授权协议和服务价目表的权力，修改后的协议或价目表对自改变之日起的新授权用户生效。 
            <p>电子文本形式的授权协议如同双方书面签署的协议一样，具有完全的和等同的法律效力。您一旦开始安装 Ctmon，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。 <br>
            <br>
            </p>
            <h2>附：</h2>
                深圳市创同盟科技有限公司网址：<a href="http://www.ctmon.com" target="_blank">http://www.ctmon.com</a><br>
        </div>
	</div>
	<div class="btn cl">
	...
	<div class="btn cl">
		<a href="javascript:history.back(-1);" class="back">上一步</a>
		<a href="javascript:;" onclick="checkDbset();" class="next">下一步</a>		
	</div>
    <script type="text/javascript">
        var showbox;
	...
	<div class="btn cl">
		<a href="javascript:history.back(-1);" class="back">上一步</a>
		<a href="javascript:;" onclick="checkforumset();" class="next">下一步</a>		
	</div>
    <script type="text/javascript">
	...
	<div class="btn cl">
		<a href="javascript:history.back(-1);" class="back">上一步</a>
		<a id="successlink" href="javascript:;" class="back">完成</a>
	</div>
    <script type="text/javascript">
        var adminname = $('#adminname').val();
        var adminpassword = $('#adminpassword').val();
    ...
    <%} %>
	<div class="copy">
		深圳市创同盟科技有限公司 &copy; 2013 - 2013 Ctmon Inc. 
	</div>
</div>
</body>
</html>