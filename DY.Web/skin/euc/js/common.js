...
$(function(){
	...
	$('.wedo_list li').hover(function(){
	    ...
	    $(this).find('.wedo_show').stop().animate({ "bottom": "0" }, 350)
	    $(this).find('.wedo_img img').stop().animate({ "opacity": "1" }, 150)
		
		},function(){

		    $(this).find('.wedo_show').stop().animate({ "bottom": "-60" }, 350)
		    $(this).find('.wedo_img img').stop().animate({ "opacity": "0.6" }, 150)
	...
	$('.float_qq2').hover(function(){
	    ...
	    $(this).stop().animate({ "left": "-70px", "width": "126px" }, 350)
		
		},function(){

		    $(this).stop().animate({ "left": "0", "width": "50px" }, 350)
			
			})	
	
	$('.float_qq3').hover(function(){

	    $(this).stop().animate({ "left": "-116px", "width": "172px" }, 350)
