        ...
        popup.prototype = {
            ...
            show: function () {
                ...
                var markup = '<div id="' + this.id + '" class="afPopup hidden '+ this.addCssClass + '">'+
                            '<header>' + this.title + '<span class="class"></span></header>' +
                             '<div>' + this.message + '</div>'+
                             '<footer style="clear:both;">'+
                                 '<a href="javascript:;" class="red ' + this.cancelClass + '" id="cancel">' + this.cancelText + '</a>' +
                                 '<a href="javascript:;" class="red ' + this.doneClass + '" id="action">' + this.doneText + '</a>' +
                            ' </footer>'+
                         '</div>';
                ...
                var $elClass = $.query("#" + this.id).find(".class");
