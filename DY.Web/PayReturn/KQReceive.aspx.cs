...
{
    public partial class PayCenter_KQReceive : DY.Site.WebPage  // System.Web.UI.Page
    {
        //初始化结果及地址
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (signMsg.ToUpper() == merchantSignMsg.ToUpper())
            {
                switch (payResult)
                {
                    case "10":
                        ...
                        //rtnOk = 1;
                        //rtnUrl = "http://www.nsw88.com/PayCenter/ShowResult.aspx?msg=success";
                        //Response.Write("1" + payResult);
                        title = "恭喜您，付款成功！";
                        content += "订 单 号：" + orderId + "</br>";
                        content += "成功支付金额：" + payAmount;
                        //更新会员积分
                        user.UpdateUserIntegral(orderId);
                    ...
                    default:
                        ...
                        //rtnOk = 1;
                        ////rtnUrl = "http://www.nsw88.com/PayCenter/ShowResult.aspx?msg=false";
                        //Response.Write("0" + payResult);
                        break;
                }
            ...
            else
            {
                ...
                content = "多次提交订单失败,请与我们的客户联系。";
                //rtnOk = 1;
                //Response.Write("2" + payResult);
                //rtnUrl = "http://www.nsw88.com/PayCenter/ShowResult.aspx?msg=error";
            }
