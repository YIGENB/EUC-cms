...
using DY.OAuthV2SDK.OAuths.Qzones.Models;

namespace DY.OAuthV2SDK.OAuths.Qzones
{
    /// <summary>
    /// QQ空间协议
    /// </summary>
    public class QzoneOAuth : OAuthBase
    {
        #region 属性
        ...
        /// 协议节点名称(区分大小写)
        /// </summary>
        public override string OAuthName { get { return "qzone"; } }
        /// <summary>
        /// 协议节点描述
        /// </summary>
        public override string OAuthDesc { get { return "QQ空间"; } }
        ...
        public QzoneOAuth(string cfgAppName)
        {
            this.ClientIp = UtilHelper.GetClientIP();
        }
        ...
        private ApiResult GetOpenId(string accessToken)
        {
            ...
            var token = Helpers.UtilHelper.ParseJson<QzoneMToken>(response);
            if (token.ret == 0)
            {
        ...
        public override ApiResult SendStatus(string accessToken, string strText)
        {
            ...
            QzoneMTweet status = UtilHelper.ParseJson<QzoneMTweet>(response);
            ApiResult api = new ApiResult();
